...
public class ChaseTask extends DefaultTask implements PriorityTask {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(ChaseTask.class);
  ...
  public void update() {
    ...
    if(currentPriority!=-1 && !alertPlaying){
      ...
      alertPlaying=true;
      LOGGER.error("RUNNINGALERT");

    } else if(currentPriority == -1 && alertPlaying) {
      LOGGER.error("SHOULDGOBACK");
      LOGGER.error("currentpriority{}", currentPriority);
